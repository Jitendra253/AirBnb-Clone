...
//edit a product
route.get('/admin/products/:id/edit', (req, res) => {
    Product.findById(req.params.id, function (err, product) {
        res.render('admin/products/edit', { product });
    });
});
//edit post route
route.post('/admin/products/:id', (req, res) => {
...
//delete a product
route.get('/admin/products/:id/delete', (req, res) => {
...
route.get('/admin/products/new', (req, res) => {
